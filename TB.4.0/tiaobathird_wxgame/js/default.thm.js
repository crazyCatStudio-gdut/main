var egret = window.egret;window.skins={};
	...
	function BeginSceneSkin() {
		...
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this.beginBtn_i(),this._Image2_i()];
	}
	...
	function GameSceneSkin() {
		_super.call(this);
		this.skinParts = ["bg","player","scoreLabel","share","blockPanel","overScoreLabel","restart","overPanel"];
	...
	_proto.blockPanel_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.bg_i(),this.player_i(),this.scoreLabel_i(),this.share_i(),this._Image1_i()];
		return t;
	};
